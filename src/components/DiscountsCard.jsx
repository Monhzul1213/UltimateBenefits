      ...
      <Form layout="vertical">
          ...
          <div style={{ width: "100%" }}>
            ...
            <Form.Item
              rules={[
                {
                  required: true,
                  message: "Хөнгөлөлт, урамшууллын нэрээ оруулна уу",
                },
              ]}
            >
              <Input
        ...
        <div className="dis-modal-flex">
          <div style={{ width: "100%" }}>
            ...
            <Form.Item
              rules={[
                { required: true, message: "Хэдэн удаа /тоогоо оруулна уу/" },
              ]}
            >
              <Input
                size="large"
          ...
          <div style={{ width: "100%" }}>
            ...
            <Form.Item
              rules={[
                {
                  required: true,
                  message: "Дэлгэрэнгүй мэдээллийг оруулна уу",
                },
              ]}
            >
              <Input.TextArea
