...
const CareerProvider = ({ children }) => {
  ...
  const getCares = async () => {
    ...
    try {
      const { data } = await myAxios.get(`/api/careers/category`, {
        headers: {
  ...
  const createCareCategory = async () => {
    ...
    try {
      await myAxios.post("/api/careers/category", formData, {
        headers: {
  ...
  const editCareCategory = async (id) => {
    ...
    formData.append("AvailableMonth", careCategoryForm.AvailableMonth);
    try {
      await myAxios.put(`/api/careers/category/${id}`, formData, {
        headers: {
          "Content-Type": "multipart/form-data",
          Authorization: `Bearer ${sessionStorage.getItem("userToken")}`,
        },
  ...
  const deleteCareCategory = async (id) => {
    try {
      await myAxios.delete(`/api/careers/category/${id}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("userToken")}`,
        },
      });
  ...
  const getCareDetail = async (id) => {
    try {
      const { data } = await myAxios.get(`/api/careers/category/detail/${id}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("userToken")}`,
        },
      });
  ...
  const editCareDetail = async (id) => {
    try {
      const { data } = await myAxios.put(
        `/api/careers/category/detail/${id}`,
        careDetailForm,
        {
          headers: {
            Authorization: `Bearer ${sessionStorage.getItem("userToken")}`,
  ...
  const deleteCareDetail = async (id) => {
    try {
      await myAxios.delete(`/api/careers/category/detail/${id}`, {
        headers: {
          Authorization: `Bearer ${sessionStorage.getItem("userToken")}`,
        },
      });
